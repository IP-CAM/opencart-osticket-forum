...
<script type="text/javascript">
    var integrated = (window.location != window.parent.location) ? true : false;
    
    var current_url = window.location.href;
    var index = current_url.indexOf("forum");
    var adm_url = current_url.indexOf("adm");
    var store_url = current_url.substr(0, index);
    
    var integrated_forum = store_url+"index.php?route=support/forum";

    if ( !integrated && store_url && (adm_url <= 0) ) { //it means customer got here by direct address access, we prevent it
        //window.location.href=store_url;
        window.location.href=integrated_forum;
        //remove any session entry for this ip in case
    }
</script>
