...
define('SECRET_SALT','dZjIHq0EomFvO.KEzR2PVinB51eu9CPd');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','polarglow06@gmail.com');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost');
define('DBNAME','newintegration');
define('DBUSER','newintegration');
define('DBPASS','newintegration');
