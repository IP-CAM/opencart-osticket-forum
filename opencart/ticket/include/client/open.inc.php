...
<?php
        if (!$thisclient && !$oc_customer) { //for hunt_easter
        ...
        //for hunt_easter
        $client_email = $thisclient ? $thisclient->getEmail() : $oc_customer['email'];
        $client_name = $thisclient ? $thisclient->getName() : $oc_customer['firstname'] . ' ' . $oc_customer['lastname'];
        // end
        ?>
